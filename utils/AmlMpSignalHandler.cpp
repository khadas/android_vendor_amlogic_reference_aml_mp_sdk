...
#define LOG_TAG "AmlMpSignalHandler"
#include "AmlMpSignalHandler.h"
#include "AmlMpLog.h"
#include <string.h>
#include <unistd.h>
#include <execinfo.h>
...
namespace aml_mp {
int AmlMpSignalHandler::installSignalHandlers()
{
    int ret = 0;
...
void AmlMpSignalHandler::unexpectedSignalHandler(int signal_number, siginfo_t *info, void* )
{
    static bool handlingUnexpectedSignal = false;
    if (handlingUnexpectedSignal) {
        MLOGE("HandleUnexpectedSignal reentered\n");
        _exit(1);
    }
...
const char* AmlMpSignalHandler::getSignalName(int signal_number)
{
...
const char* AmlMpSignalHandler::getSignalCodeName(int signal_number, int signal_code)
{
...
void AmlMpSignalHandler::dumpstack(std::ostream& os)
{
  char* stack[20] = {0};
...
std::string AmlMpSignalHandler::demangleSymbol(const char* symbol)
{
    std::string result;
