...
class AmlMpRefBase::weakref_impl : public AmlMpRefBase::weakref_type
{
public:
    std::atomic<int32_t>    mStrong;
    std::atomic<int32_t>    mWeak;
    AmlMpRefBase* const          mBase;
    std::atomic<int32_t>    mFlags;

#if !DEBUG_REFS

    explicit weakref_impl(AmlMpRefBase* base)
    ...
    weakref_impl(AmlMpRefBase* base)
        : mStrong(INITIAL_STRONG_VALUE)
        , mWeak(0)
        , mBase(base)
        , mFlags(0)
    ...
    void printRefs() const
    {
...

        {
            ...
            snprintf(buf, sizeof(buf),
                     "Strong references on AmlMpRefBase %p (weakref_type %p):\n",
                     mBase, this);
            text.append(buf);
            printRefsLocked(&text, mStrongRefs);
            snprintf(buf, sizeof(buf),
                     "Weak references on AmlMpRefBase %p (weakref_type %p):\n",
                     mBase, this);
            text.append(buf);
...
void AmlMpRefBase::incStrong(const void* id) const
{
...
void AmlMpRefBase::decStrong(const void* id) const
{
    weakref_impl* const refs = mRefs;
...
void AmlMpRefBase::forceIncStrong(const void* id) const
{
...
int32_t AmlMpRefBase::getStrongCount() const
{
    // Debugging only; No memory ordering guarantees.
    return mRefs->mStrong.load(std::memory_order_relaxed);
}

AmlMpRefBase* AmlMpRefBase::weakref_type::refBase() const
{
    return static_cast<const weakref_impl*>(this)->mBase;
}

void AmlMpRefBase::weakref_type::incWeak(const void* id)
{
...
void AmlMpRefBase::weakref_type::decWeak(const void* id)
{
    weakref_impl* const impl = static_cast<weakref_impl*>(this);
...
bool AmlMpRefBase::weakref_type::attemptIncStrong(const void* id)
{
    incWeak(id);
...
bool AmlMpRefBase::weakref_type::attemptIncWeak(const void* id)
{
    weakref_impl* const impl = static_cast<weakref_impl*>(this);
...
int32_t AmlMpRefBase::weakref_type::getWeakCount() const
{
    // Debug only!
...
void AmlMpRefBase::weakref_type::printRefs() const
{
    static_cast<const weakref_impl*>(this)->printRefs();
}

void AmlMpRefBase::weakref_type::trackMe(bool enable, bool retain)
{
    static_cast<weakref_impl*>(this)->trackMe(enable, retain);
}

AmlMpRefBase::weakref_type* AmlMpRefBase::createWeak(const void* id) const
{
    mRefs->incWeak(id);
    return mRefs;
}

AmlMpRefBase::weakref_type* AmlMpRefBase::getWeakRefs() const
{
    return mRefs;
}

AmlMpRefBase::AmlMpRefBase()
...
void AmlMpRefBase::extendObjectLifetime(int32_t mode)
{
...
void AmlMpRefBase::onFirstRef()
{
}

void AmlMpRefBase::onLastStrongRef(const void* /*id*/)
{
}

bool AmlMpRefBase::onIncStrongAttempted(uint32_t flags, const void* /*id*/)
{
    return (flags&FIRST_INC_STRONG) ? true : false;
}

void AmlMpRefBase::onLastWeakRef(const void* /*id*/)
{
}
...
#if DEBUG_REFS
void AmlMpRefBase::renameRefs(size_t n, const ReferenceRenamer& renamer) {
...
void AmlMpRefBase::renameRefId(weakref_type* ref,
...
void AmlMpRefBase::renameRefId(AmlMpRefBase* ref,
        const void* old_id, const void* new_id) {
