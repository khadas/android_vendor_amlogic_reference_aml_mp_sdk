...
LOCAL_SHARED_LIBRARIES := $(AML_MP_PLAYER_DEMO_SHARED_LIBS) $(AML_MP_PLAYER_DEMO_SHARED_LIBS_ge_30)
endif
...
LOCAL_C_INCLUDES := $(AML_MP_PLAYER_DEMO_INC)
ifeq (1, $(shell expr $(PLATFORM_SDK_VERSION) \>= 30))
LOCAL_SHARED_LIBRARIES := $(AML_MP_PLAYER_DEMO_SHARED_LIBS) $(AML_MP_PLAYER_DEMO_VENDOR_SHARED_LIBS_ge_30)
endif
