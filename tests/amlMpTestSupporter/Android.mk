...
AML_MP_TEST_SUPPORTER_SHARED_LIBS_ge_30 := \
	libaml_mp_sdk \
	libamdvr.system \
	libgui \

AML_MP_TEST_SUPPORTER_VENDOR_SHARED_LIBS_ge_30 := \
	libaml_mp_sdk.vendor \
	libamdvr \
...
LOCAL_SHARED_LIBRARIES := $(AML_MP_TEST_SUPPORTER_SHARED_LIBS) $(AML_MP_TEST_SUPPORTER_SHARED_LIBS_ge_30)
endif
...
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)
ifeq (1, $(shell expr $(PLATFORM_SDK_VERSION) \>= 30))
LOCAL_SHARED_LIBRARIES := $(AML_MP_TEST_SUPPORTER_SHARED_LIBS) $(AML_MP_TEST_SUPPORTER_VENDOR_SHARED_LIBS_ge_30)
endif
#LOCAL_STATIC_LIBRARIES :=
#LOCAL_WHOLE_STATIC_LIBRARIES :=
#LOCAL_LDFLAGS :=
